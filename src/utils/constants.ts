...
export const situacionCrediticiaList = [
  ...
  { value: 's3', label: 'Situación 3' },
  { value: 's4', label: 'Situación 3' },
  { value: 's5', label: 'Situación 4' },
];
...
export const civilStateList = [
  ...
  { value: 'co', label: 'Convivencia' },
  { value: 'di', label: 'Divorciado/a' },
  { value: 'se', label: 'Separada de hecho' },
  { value: 's', label: 'Soltero/a' },
  { value: 'vi', label: 'Viudo/a' },
  { value: 'si', label: 'Sin información' },
];
...
export const recuperoCSList = [
  { value: 'bancario', label: 'Descuento Bancario' },
  { value: 'bica', label: 'Descuento BICA' },
  { value: 'haberes', label: 'Descuento Haberes' },
  { value: 'rgm', label: 'Descuento RGM' },
