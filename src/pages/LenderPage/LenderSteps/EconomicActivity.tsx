...
const EconomicActivity = () => {
  ...
  const { inputs, onChangeHanlder, updateInputs } = useInputChange(economicActivityState);
  ...
  const config = economicActivityConfig(inputs, updateInputs, formHasBeenSubmited);
