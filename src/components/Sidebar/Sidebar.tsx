...
// core components
import AdminNavbarLinks from 'components/AdminNavbar/AdminNavbarLinks';
...
class SidebarWrapper extends React.Component<any, any> {
...
class Sidebar extends Component<any, any> {
  ...
  mainPanel = createRef<HTMLDivElement>();
  ...
  createLinks = routes => {
    const { classes, color, rtlActive }: any = this.props;
